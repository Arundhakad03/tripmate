...
if __name__ == "__main__":
    print("=" * 50)
    print("  TripMate - tera personal travel assistant")
    print("  (bahar nikalne ke liye '0' likh de)")
    print("=" * 50)
    ...
    while True:
        ...
        if user_input == "0":
            print("\nTripMate: Chalo phir, safar mubarak ho!")
            break
        ...
        try:
            ...
            while response.tool_calls:
                print("\nTripMate: ek second, dhoondh raha hoon...")
            ...
            print(f"\nTripMate: {response.content}")

        except Exception as e:
            print(f"\nTripMate: Arre yaar, kuch gadbad ho gayi - {str(e)}")
            print("Dobara try kar please.")
